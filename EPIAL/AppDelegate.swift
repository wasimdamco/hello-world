...
//        UITabBar.appearance().backgroundImage = UIImage()
   ...
   // NSUserDefaults.standardUserDefaults().setObject("yes", forKey: "isPractitionerPresent")
	...
	lazy var applicationDocumentsDirectory: NSURL = {
		// The directory the application uses to store the Core Data store file. This code uses a directory named "com.damco.EPIAL" in the application's documents Application Support directory.
	...
	lazy var managedObjectModel: NSManagedObjectModel = {
		...
		let modelURL = NSBundle.mainBundle().URLForResource("EPIAL", withExtension: "momd")!
    ...
    func handleAppFLow(){
        ...
        if NSUserDefaults.standardUserDefaults().valueForKey("cookie") != nil{
            ...
            viewControllerToBeShown = tabBarVc
        }else{
            ...
            viewControllerToBeShown = loginVcNavigationController
        }
