...
#import "/Users/User/Documents/Damco_Projects/05_EPIAL/EPILTeam_20151222/EPIAL-Bridging-Header.h"
...
SWIFT_CLASS("_TtC5EPIAL11AppDelegate")
...
SWIFT_CLASS("_TtC5EPIAL9ChartData")
...
@property (nonatomic, copy) NSArray<ChartDataSet *> * __null_unspecified _dataSets;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
- (void)initialize:(NSArray<ChartDataSet *> * __nonnull)dataSets;
- (void)calcXValAverageLength;
- (void)checkIsLegal:(NSArray<ChartDataSet *> * __null_unspecified)dataSets;
...
SWIFT_CLASS("_TtC5EPIAL35BarLineScatterCandleBubbleChartData")
...
SWIFT_CLASS("_TtC5EPIAL12BarChartData")
...
SWIFT_CLASS("_TtC5EPIAL14ChartDataEntry")
...
SWIFT_CLASS("_TtC5EPIAL17BarChartDataEntry")
...
SWIFT_PROTOCOL("_TtP5EPIAL17ChartDataProvider_")
...
SWIFT_PROTOCOL("_TtP5EPIAL43BarLineScatterCandleBubbleChartDataProvider_")
...
SWIFT_PROTOCOL("_TtP5EPIAL20BarChartDataProvider_")
...
SWIFT_CLASS("_TtC5EPIAL12ChartDataSet")
...
SWIFT_CLASS("_TtC5EPIAL38BarLineScatterCandleBubbleChartDataSet")
...
SWIFT_CLASS("_TtC5EPIAL15BarChartDataSet")
...
SWIFT_CLASS("_TtC5EPIAL17ChartRendererBase")
...
@property (nonatomic) NSInteger _minX;

/// the maximum value on the x-axis that should be plotted
@property (nonatomic) NSInteger _maxX;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
- (BOOL)fitsBounds:(double)val min:(double)min max:(double)max;
...
SWIFT_CLASS("_TtC5EPIAL21ChartDataRendererBase")
...
SWIFT_CLASS("_TtC5EPIAL16BarChartRenderer")
...
- (void)drawDataWithContext:(CGContextRef __nonnull)context;
- (void)drawDataSetWithContext:(CGContextRef __nonnull)context dataSet:(BarChartDataSet * __nonnull)dataSet index:(NSInteger)index;
- (void)drawValuesWithContext:(CGContextRef __nonnull)context;
...
SWIFT_PROTOCOL("_TtP5EPIAL21ChartAnimatorDelegate_")
...
SWIFT_CLASS("_TtC5EPIAL13ChartViewBase")
...
SWIFT_CLASS("_TtC5EPIAL20BarLineChartViewBase")
...
SWIFT_CLASS("_TtC5EPIAL12BarChartView")
...
SWIFT_PROTOCOL("_TtP5EPIAL18ChartFillFormatter_")
...
SWIFT_CLASS("_TtC5EPIAL25BarLineChartFillFormatter")
...
SWIFT_CLASS("_TtC5EPIAL19BodyPartsDetailView")
@interface BodyPartsDetailView : UIView
@property (nonatomic, weak) IBOutlet UIImageView * __null_unspecified bodyPartImageView;
@property (nonatomic, weak) IBOutlet UITextView * __null_unspecified bodyDetailTextView;
@property (nonatomic, readonly, strong) BodyPartsDetailView * __nonnull bodyPartsDetailView;
- (void)configureView:(NSDictionary<NSString *, NSString *> * __nonnull)details;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC5EPIAL29BodyPartsDetailViewController")
@interface BodyPartsDetailViewController : UIViewController <UIScrollViewDelegate, PunchScrollViewDelegate, PunchScrollViewDataSource>
@property (nonatomic, weak) IBOutlet UIPageControl * __null_unspecified pageControl;
@property (nonatomic, weak) IBOutlet PunchScrollView * __null_unspecified scrollviewBase;
@property (nonatomic, copy) NSString * __nullable selectedBodyPart;
- (void)viewDidLoad;
- (void)viewWillDisappear:(BOOL)animated;
- (void)didReceiveMemoryWarning;
- (void)configurePageControl;
- (NSInteger)numberOfSectionsInPunchScrollView:(PunchScrollView * __null_unspecified)scrollView;
- (NSInteger)punchscrollView:(PunchScrollView * __null_unspecified)scrollView numberOfPagesInSection:(NSInteger)section;
- (UIView * __null_unspecified)punchScrollView:(PunchScrollView * __null_unspecified)scrollView viewForPageAtIndexPath:(NSIndexPath * __null_unspecified)indexPath;
- (void)loadSourceData;
...
SWIFT_CLASS("_TtC5EPIAL15BubbleChartData")
...
SWIFT_CLASS("_TtC5EPIAL20BubbleChartDataEntry")
...
SWIFT_PROTOCOL("_TtP5EPIAL23BubbleChartDataProvider_")
...
SWIFT_CLASS("_TtC5EPIAL18BubbleChartDataSet")
...
SWIFT_CLASS("_TtC5EPIAL19BubbleChartRenderer")
...
- (void)drawDataWithContext:(CGContextRef __nonnull)context;
- (void)drawDataSetWithContext:(CGContextRef __nonnull)context dataSet:(BubbleChartDataSet * __nonnull)dataSet;
- (void)drawValuesWithContext:(CGContextRef __nonnull)context;
- (void)drawExtrasWithContext:(CGContextRef __nonnull)context;
- (void)drawHighlightedWithContext:(CGContextRef __nonnull)context indices:(NSArray<ChartHighlight *> * __nonnull)indices;
@end
...
SWIFT_CLASS("_TtC5EPIAL15BubbleChartView")
...
SWIFT_CLASS("_TtC5EPIAL15CandleChartData")
...
SWIFT_CLASS("_TtC5EPIAL20CandleChartDataEntry")
...
SWIFT_PROTOCOL("_TtP5EPIAL23CandleChartDataProvider_")
...
SWIFT_CLASS("_TtC5EPIAL29LineScatterCandleChartDataSet")
...
SWIFT_CLASS("_TtC5EPIAL18CandleChartDataSet")
...
SWIFT_CLASS("_TtC5EPIAL35LineScatterCandleRadarChartRenderer")
...
SWIFT_CLASS("_TtC5EPIAL24CandleStickChartRenderer")
...
- (void)drawDataWithContext:(CGContextRef __nonnull)context;
- (void)drawDataSetWithContext:(CGContextRef __nonnull)context dataSet:(CandleChartDataSet * __nonnull)dataSet;
- (void)drawValuesWithContext:(CGContextRef __nonnull)context;
- (void)drawExtrasWithContext:(CGContextRef __nonnull)context;
- (void)drawHighlightedWithContext:(CGContextRef __nonnull)context indices:(NSArray<ChartHighlight *> * __nonnull)indices;
@end
...
SWIFT_CLASS("_TtC5EPIAL20CandleStickChartView")
...
SWIFT_CLASS("_TtC5EPIAL13ChartAnimator")
...
SWIFT_CLASS("_TtC5EPIAL18ChartComponentBase")
...
SWIFT_CLASS("_TtC5EPIAL13ChartAxisBase")
...
SWIFT_CLASS("_TtC5EPIAL21ChartAxisRendererBase")
...
SWIFT_CLASS("_TtC5EPIAL19ChartColorTemplates")
...
SWIFT_CLASS("_TtC5EPIAL19ChartDataBaseFilter")
...
SWIFT_CLASS("_TtC5EPIAL27ChartDataApproximatorFilter")
...
SWIFT_PROTOCOL("_TtP5EPIAL24ChartXAxisValueFormatter_")
...
/// An interface for providing custom x-axis Strings.
SWIFT_CLASS("_TtC5EPIAL31ChartDefaultXAxisValueFormatter")
...
SWIFT_CLASS("_TtC5EPIAL14ChartHighlight")
...
SWIFT_CLASS("_TtC5EPIAL11ChartLegend")
...
SWIFT_CLASS("_TtC5EPIAL19ChartLegendRenderer")
...
SWIFT_CLASS("_TtC5EPIAL14ChartLimitLine")
...
SWIFT_CLASS("_TtC5EPIAL11ChartMarker")
...
SWIFT_CLASS("_TtC5EPIAL10ChartRange")
...
SWIFT_CLASS("_TtC5EPIAL20ChartSelectionDetail")
...
SWIFT_CLASS("_TtC5EPIAL16ChartTransformer")
...
SWIFT_CLASS("_TtC5EPIAL34ChartTransformerHorizontalBarChart")
...
SWIFT_PROTOCOL("_TtP5EPIAL17ChartViewDelegate_")
@protocol ChartViewDelegate
@optional
...
SWIFT_CLASS("_TtC5EPIAL20ChartViewPortHandler")
...
SWIFT_CLASS("_TtC5EPIAL10ChartXAxis")
...
SWIFT_CLASS("_TtC5EPIAL18ChartXAxisRenderer")
...
SWIFT_CLASS("_TtC5EPIAL26ChartXAxisRendererBarChart")
@interface ChartXAxisRendererBarChart : ChartXAxisRenderer
@property (nonatomic, weak) BarChartView * __null_unspecified _chart;
...
SWIFT_CLASS("_TtC5EPIAL36ChartXAxisRendererHorizontalBarChart")
...
SWIFT_CLASS("_TtC5EPIAL28ChartXAxisRendererRadarChart")
...
SWIFT_CLASS("_TtC5EPIAL10ChartYAxis")
...
SWIFT_CLASS("_TtC5EPIAL18ChartYAxisRenderer")
@interface ChartYAxisRenderer : ChartAxisRendererBase
@property (nonatomic, strong) ChartYAxis * __null_unspecified _yAxis;
...
SWIFT_CLASS("_TtC5EPIAL36ChartYAxisRendererHorizontalBarChart")
...
SWIFT_CLASS("_TtC5EPIAL28ChartYAxisRendererRadarChart")
...
SWIFT_CLASS("_TtC5EPIAL17CombinedChartData")
...
SWIFT_CLASS("_TtC5EPIAL21CombinedChartRenderer")
@interface CombinedChartRenderer : ChartDataRendererBase
@property (nonatomic, weak) CombinedChartView * __null_unspecified _chart;
...
SWIFT_PROTOCOL("_TtP5EPIAL21LineChartDataProvider_")
...
SWIFT_PROTOCOL("_TtP5EPIAL24ScatterChartDataProvider_")
...
SWIFT_CLASS("_TtC5EPIAL17CombinedChartView")
...
SWIFT_CLASS("_TtC5EPIAL26DeviceDetailViewController")
@interface DeviceDetailViewController : UIViewController <UIScrollViewDelegate, UITableViewDelegate, UITableViewDataSource>
@property (nonatomic, copy) NSArray<NSString *> * __nonnull dataSource;
@property (nonatomic, strong) UIDocumentInteractionController * __nullable documentInteractionController;
- (void)viewDidLoad;
...
/// Function will confirm action on DeviceM selected option. If 0 to 2nd row is selected then PDF view needs to be opened else Body part that is Probes Treatment Strategy controller will be opened. :parameter:: selectedRow: Int to identify which row is selected.
- (void)deviceMOptionSelectionAction:(NSInteger)selectedRow selectedCell:(UITableViewCell * __nonnull)selectedCell;
- (void)loadnib;
- (nonnull instancetype)initWithNibName:(NSString * __nullable)nibNameOrNil bundle:(NSBundle * __nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
/// Class: EPDatePickerView: The UIView model class which the controller needs to implement to have the picker on controller's view. The controller needs to make a instance of the EPDatePickerView model class and provide the frame as to where the picker needs to appear on the view and set the delegate to self, to get the callback for selected date from the picker.
SWIFT_CLASS("_TtC5EPIAL16EPDatePickerView")
@interface EPDatePickerView : UIView
@property (nonatomic, weak) IBOutlet UIDatePicker * __null_unspecified datePicker;
@property (nonatomic, weak) IBOutlet UILabel * __null_unspecified pickerTitle;

/// Class function to initialize the view from nib. the function loads the EPDatePickerView nib and sets the nib for the view. :returns: EPDatePickerView object
+ (id __nullable)initWithNib;

/// Button action function to respond back with selected date value from the datePicker.
- (IBAction)selectedDate:(id __nonnull)sender;
- (IBAction)doneButtonClicked:(id __nonnull)sender;
...
SWIFT_CLASS("_TtC5EPIAL18EPHistoryTableView")
@interface EPHistoryTableView : UIView <UIScrollViewDelegate, UITableViewDelegate, UITableViewDataSource>
@property (nonatomic, weak) IBOutlet UITableView * __null_unspecified historyTable;
@property (nonatomic, copy) NSArray<Logger *> * __nullable dataSource;
+ (id __nullable)initWithNib;

/// function to refreash the table data list and reload table.
- (void)refreshView;
- (void)tableView:(UITableView * __nonnull)tableView willDisplayCell:(UITableViewCell * __nonnull)cell forRowAtIndexPath:(NSIndexPath * __nonnull)indexPath;
- (NSInteger)tableView:(UITableView * __nonnull)tableView numberOfRowsInSection:(NSInteger)section;
- (UITableViewCell * __nonnull)tableView:(UITableView * __nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * __nonnull)indexPath;
...
/// Function to remove item from selected index of table datasource. The function calls the deleteHistory method of Logger entity class and pass the selected logger instance object to be deleted from entity. And then refreashView function is called. :parameter: index: Index of selected item from table.
- (void)removeObjectAtIndex:(NSInteger)index;

/// Function to convert NSDate object to String type object. The date format can be updated here for different types of date formats. :parameter: dateReceived: of type NSDate and converted into String value which is returned by the method.
- (NSString * __nonnull)getDateTimeInString:(NSDate * __nonnull)dateReceived;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC5EPIAL22EPHistoryTableViewCell")
@interface EPHistoryTableViewCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UILabel * __null_unspecified painLevelValue;
@property (nonatomic, weak) IBOutlet UILabel * __null_unspecified treatmentDurationValue;
@property (nonatomic, weak) IBOutlet UILabel * __null_unspecified dateTimeValue;
@property (nonatomic, weak) IBOutlet UILabel * __null_unspecified typeValue;
...
/// Class: EPNavigationController the subclass of UINavigationController. The class is designed to customize the navigation controller so to give custom effects. A function awakeFromNib is overridden so that all the custom effects gets applied on as the navigation is loaded. The customization of navigationController include title color change, fon change , background image change etc.
SWIFT_CLASS("_TtC5EPIAL22EPNavigationController")
...
/// Class: EPPickerView: The UIView model class which the controller needs to implement to have the picker on controller's view. The controller needs to make a instance of the EPPickerView model class and provide the frame as to where the picker needs to appear on the view and set the delegate to self, to get the callback for selected item from the picker.
SWIFT_CLASS("_TtC5EPIAL12EPPickerView")
...
@property (nonatomic, copy) NSArray<NSString *> * __nullable pickerDataSoruce;

/// Class function to initialize the view from nib. the function loads the EPPickerView nib and sets the nib for the view. :returns: EPPickerView object
+ (id __nullable)initWithNib;
...
SWIFT_CLASS("_TtC5EPIAL16ElectronicManual")
@interface ElectronicManual : UIViewController
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (IBAction)deviceMSelected:(id __nonnull)sender;
- (IBAction)deviceAIDSelected:(id __nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * __nullable)nibNameOrNil bundle:(NSBundle * __nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
/// Class: GraphViewController is the controller class that displays the graph on screeen. It uses the third party charts library "https://github.com/danielgindi/ios-charts". It is a ports of Android library MPAndroidChart to ios. The components from this library have been integrated into the project. This class implements the ChartViewDelegate to handle all delegate events of the class. CombinedChartView contains multiple charts and supports following charts for example, BarLineChartViewBase, LineChartDataProvider, BarChartDataProvider, ScatterChartDataProvider, CandleChartDataProvider, BubbleChartDataProvider. In this chart class we support 2 types of charts, bar chart and line chart. The bar chart is plotted against the right side y-axis and line chart is plotted against left side y-axis. All configuration settings for the chart are done under the function configureChart(). Specific chart data for line chart and for bar chart is generated by functions generateLineData and generateBarData respectively.
SWIFT_CLASS("_TtC5EPIAL19GraphViewController")
@interface GraphViewController : UIViewController <ChartViewDelegate>
@property (nonatomic, weak) IBOutlet CombinedChartView * __null_unspecified chartView;
@property (nonatomic, copy) NSArray<Logger *> * __nonnull loggerArray;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
- (void)viewDidAppear:(BOOL)animated;

/// Function to set configurations for the chart to display bar data and line data. You can customize the color of bars and line as well as circles that are displayed on screen. We also set the background color of the chart and other settings that can configure the complete chart view. If any of the settings are changed the same can be seen on chart displaying the data. This method is called via viewWillAppear() so that every time the chart gets loaded with changed and updated data.
- (void)configureChart;
...
- (LineChartData * __nonnull)generateLineData;
...
- (BarChartData * __nonnull)generateBarData;
...
- (NSArray<NSString *> * __nonnull)generateXAxisData;
- (nonnull instancetype)initWithNibName:(NSString * __nullable)nibNameOrNil bundle:(NSBundle * __nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC5EPIAL26HorizontalBarChartRenderer")
...
SWIFT_CLASS("_TtC5EPIAL22HorizontalBarChartView")
...
SWIFT_CLASS("_TtC5EPIAL23HumanBodyViewController")
@interface HumanBodyViewController : UIViewController
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (IBAction)partSelected:(id __nonnull)sender;
- (BodyPartsDetailViewController * __nonnull)instantiateBodyDetailViewController;
- (nonnull instancetype)initWithNibName:(NSString * __nullable)nibNameOrNil bundle:(NSBundle * __nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC5EPIAL13LineChartData")
...
SWIFT_CLASS("_TtC5EPIAL21LineRadarChartDataSet")
...
SWIFT_CLASS("_TtC5EPIAL16LineChartDataSet")
...
SWIFT_CLASS("_TtC5EPIAL17LineChartRenderer")
...
- (void)drawDataWithContext:(CGContextRef __nonnull)context;
- (void)drawDataSetWithContext:(CGContextRef __nonnull)context dataSet:(LineChartDataSet * __nonnull)dataSet;
- (void)drawCubicWithContext:(CGContextRef __nonnull)context dataSet:(LineChartDataSet * __nonnull)dataSet entries:(NSArray<ChartDataEntry *> * __nonnull)entries;
- (void)drawCubicFillWithContext:(CGContextRef __nonnull)context dataSet:(LineChartDataSet * __nonnull)dataSet spline:(CGMutablePathRef __nonnull)spline matrix:(CGAffineTransform)matrix from:(NSInteger)from to:(NSInteger)to;
- (void)drawLinearWithContext:(CGContextRef __nonnull)context dataSet:(LineChartDataSet * __nonnull)dataSet entries:(NSArray<ChartDataEntry *> * __nonnull)entries;
- (void)drawLinearFillWithContext:(CGContextRef __nonnull)context dataSet:(LineChartDataSet * __nonnull)dataSet entries:(NSArray<ChartDataEntry *> * __nonnull)entries minx:(NSInteger)minx maxx:(NSInteger)maxx trans:(ChartTransformer * __nonnull)trans;
- (void)drawValuesWithContext:(CGContextRef __nonnull)context;
- (void)drawExtrasWithContext:(CGContextRef __nonnull)context;
- (void)drawHighlightedWithContext:(CGContextRef __nonnull)context indices:(NSArray<ChartHighlight *> * __nonnull)indices;
@end
...
SWIFT_CLASS("_TtC5EPIAL13LineChartView")
...
/// Class: Logger and NSManagedObject class which will maintain the history of all records. The class implements some class level functions like add history , fetchAllHistory and deleteHistory to perform some actions. The entity table maintain painLevel, treatmentDuration, date and type.
SWIFT_CLASS("_TtC5EPIAL6Logger")
@interface Logger : NSManagedObject

/// Class level function to add history data record in "Logger" table and save the details in to database table. :parameter : painLevel: Int value for selected pain level :parameter: treatmentDuration: Int value for the duration of treatment taken. :parameter: Date: NSDate value for the selected date of treatment :parameter: type: String value for type of problem for which the other details have been logged.
+ (void)addHistory:(NSInteger)painLevel treatmentDuration:(NSInteger)treatmentDuration Date:(NSDate * __nonnull)Date type:(NSString * __nonnull)type;

/// Class level function to fetch all the history records from "Logger" entity table. :returns: Logger instances array
+ (NSArray<Logger *> * __nullable)fetchAllHistory;

/// Class level function to delete a Logger instance from the entity table. :parameter: Logger entity object to be deleted.
+ (void)deleteHistory:(Logger * __nonnull)object;
...
@interface Logger (SWIFT_EXTENSION(EPIAL))
@property (nonatomic, strong) NSNumber * __nullable treatmentDuration;
@property (nonatomic, strong) NSNumber * __nullable painLevel;
@property (nonatomic, strong) NSDate * __nullable dateTime;
@property (nonatomic, strong) NSNumber * __nullable id;
@property (nonatomic, copy) NSString * __nullable types;
@end

@class UIButton;


/// Class: LoggerViewController is the controller class that implements the functions to record all the required information about Electomedical device outputs. The class has sections from which the actual machine outputs or readings can be recorded. Like Pain level, treatmentDuration , type etc. All the inputs messures are predefind and user need to choose any one from them. This is implemented via UIPickerView and UiDatePicker. The views are created at separate classes name EPPickerView and EPDatePickerView . The classes are instantiated via openDataPickerWithDataSource function by passing the array of dataSource. Controller also implements the delegate functions of these views class. so on selection proper value action is taken on the controller.
SWIFT_CLASS("_TtC5EPIAL20LoggerViewController")
@interface LoggerViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIView * __null_unspecified buttonView;
@property (nonatomic, weak) IBOutlet UIButton * __null_unspecified painButton;
@property (nonatomic, weak) IBOutlet UIButton * __null_unspecified treatmentButton;
@property (nonatomic, weak) IBOutlet UIButton * __null_unspecified dateTimeButton;
@property (nonatomic, weak) IBOutlet UIButton * __null_unspecified typesButton;
@property (nonatomic, strong) EPHistoryTableView * __nullable historyView;
@property (nonatomic, weak) IBOutlet UILabel * __null_unspecified levelLabel;
@property (nonatomic, weak) IBOutlet UIView * __null_unspecified tableContainer;
...
@property (nonatomic) NSInteger yAxisRange;
@property (nonatomic, copy) NSArray<NSString *> * __nonnull yDataSourceValues;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
- (void)setupView;
- (void)didReceiveMemoryWarning;
- (IBAction)treatmentDurationPressed:(id __nonnull)sender;
- (IBAction)painLevelPressed:(id __nonnull)sender;
- (IBAction)dateTimePressed:(id __nonnull)sender;
- (IBAction)typesPressed:(id __nonnull)sender;
- (IBAction)submitButton:(id __nonnull)sender;

/// Function to check if the entry for same date is present in logs. If the entry is already present, then user is asked if he/ she wants to overwrite the previous value. If the user taps on "Yes", the values is overwritten, else the new valus is discarded. The user can record only 1 log value for a specific date/ time
- (BOOL)checkForNewLog:(NSInteger)painLevel treatmentDuration:(NSInteger)treatmentDuration Date:(NSDate * __nonnull)Date type:(NSString * __nonnull)type;

/// Function to remove added subview of picker type. This will check for any EPPicker or EPDatePicker class and if such view is found added to controller's view then that will be removed from parent or super view.
- (void)removePickerSubView;

/// Function to add History Table view onto the lower portion of the screen. This view acts as the recorder/ logger and displays recorded information. The user can swipe the table view cell to left and delete record as well.
- (void)addHistoryTableView:(CGRect)frame;
- (void)cancelButtonClicked;
- (IBAction)resetButtonClicked:(id __nonnull)sender;

/// Function to convert String object to NSDate type object. The date format can be updated here for different types of date formats. :parameter: dateReceived: of type String and converted into NSDate value which is returned by the method.
- (NSDate * __nonnull)getDateTimeInNSDate:(NSString * __nonnull)dateReceived;
- (void)setDefaultTime;
- (nonnull instancetype)initWithNibName:(NSString * __nullable)nibNameOrNil bundle:(NSBundle * __nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC5EPIAL17PDFViewController")
@interface PDFViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIWebView * __null_unspecified pdfWebView;
@property (nonatomic, copy) NSString * __nullable pdfFileName;
@property (nonatomic, copy) NSString * __nullable titleText;
- (void)viewDidLoad;

/// The function openPdf() is used to load the pdf file from project resources folder. param: fileName of type String, is the name of the pdf file that needs to be loaded onto webview.
- (void)openPdf:(NSString * __nullable)fileName;
- (void)didReceiveMemoryWarning;
...
SWIFT_CLASS("_TtC5EPIAL12PieChartData")
...
SWIFT_CLASS("_TtC5EPIAL15PieChartDataSet")
...
SWIFT_CLASS("_TtC5EPIAL16PieChartRenderer")
@interface PieChartRenderer : ChartDataRendererBase
@property (nonatomic, weak) PieChartView * __null_unspecified _chart;
...
- (void)drawDataWithContext:(CGContextRef __nonnull)context;
- (void)drawDataSetWithContext:(CGContextRef __nonnull)context dataSet:(PieChartDataSet * __nonnull)dataSet;
- (void)drawValuesWithContext:(CGContextRef __nonnull)context;
- (void)drawExtrasWithContext:(CGContextRef __nonnull)context;
- (void)drawHighlightedWithContext:(CGContextRef __nonnull)context indices:(NSArray<ChartHighlight *> * __nonnull)indices;
@end
...
SWIFT_CLASS("_TtC5EPIAL21PieRadarChartViewBase")
...
SWIFT_CLASS("_TtC5EPIAL12PieChartView")
...
SWIFT_CLASS("_TtC5EPIAL14RadarChartData")
...
SWIFT_CLASS("_TtC5EPIAL17RadarChartDataSet")
...
SWIFT_CLASS("_TtC5EPIAL18RadarChartRenderer")
@interface RadarChartRenderer : LineScatterCandleRadarChartRenderer
@property (nonatomic, weak) RadarChartView * __null_unspecified _chart;
...
- (void)drawDataWithContext:(CGContextRef __nonnull)context;
- (void)drawDataSetWithContext:(CGContextRef __nonnull)context dataSet:(RadarChartDataSet * __nonnull)dataSet;
- (void)drawValuesWithContext:(CGContextRef __nonnull)context;
- (void)drawExtrasWithContext:(CGContextRef __nonnull)context;
...
SWIFT_CLASS("_TtC5EPIAL14RadarChartView")
...
SWIFT_CLASS("_TtC5EPIAL16ScatterChartData")
...
SWIFT_CLASS("_TtC5EPIAL19ScatterChartDataSet")
...
SWIFT_CLASS("_TtC5EPIAL20ScatterChartRenderer")
...
- (void)drawDataWithContext:(CGContextRef __nonnull)context;
- (void)drawDataSetWithContext:(CGContextRef __nonnull)context dataSet:(ScatterChartDataSet * __nonnull)dataSet;
- (void)drawValuesWithContext:(CGContextRef __nonnull)context;
- (void)drawExtrasWithContext:(CGContextRef __nonnull)context;
- (void)drawHighlightedWithContext:(CGContextRef __nonnull)context indices:(NSArray<ChartHighlight *> * __nonnull)indices;
@end
...
SWIFT_CLASS("_TtC5EPIAL16ScatterChartView")
...
SWIFT_CLASS("_TtC5EPIAL17TabViewController")
