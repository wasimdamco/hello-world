...
{
    var deltaForMoreThanOneValue: Int? = 0
    ...
    public init(dataProvider: LineChartDataProvider?, animator: ChartAnimator?, viewPortHandler: ChartViewPortHandler)
    {
        ...
        let count: Int = (NSUserDefaults.standardUserDefaults().valueForKey("deltaForMoreThanOneValue") as? Int)!
        deltaForMoreThanOneValue = count > 1 ? 1 : 0
    ...
    public override func drawData(context context: CGContext)
    {
        ...
        print("lineData.dataSetCount = \(lineData.dataSetCount)")
        print("deltaForMoreThanOneValue = \(deltaForMoreThanOneValue)")
    ...
    internal func drawCubic(context context: CGContext, dataSet: LineChartDataSet, entries: [ChartDataEntry])
    {
        ...
        let maxx = min(max(minx + 2, dataSet.entryIndex(entry: entryTo, isEqual: true) + 1), entries.count) + deltaForMoreThanOneValue!
